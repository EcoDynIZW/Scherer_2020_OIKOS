...
theme_custom <- function (base_size = 12, base_family = base)
{
  ...
  theme(line = element_line(colour = "grey40", size = 0.4, linetype = 1, lineend = "butt"), 
        rect = element_rect(fill = "white", colour = "grey40", size = 0.4, linetype = 1), 
        ...
        axis.line.x = NULL, 
        axis.line.y = NULL, 
        axis.text = element_text(size = base_size * 1.1, colour = "grey40"), 
        axis.text.x = element_text(margin = margin(t = 0.8 * half_line/2), vjust = 1), 
        axis.text.x.top = element_text(margin = margin(b = 0.8 * half_line/2), vjust = 0), 
        axis.text.y = element_text(margin = margin(r = 0.8 * half_line/2), hjust = 1), 
        axis.text.y.right = element_text(margin = margin(l = 0.8 * half_line/2), hjust = 0), 
        axis.ticks = element_line(colour = "grey40", size = 0.4), 
        ...
        panel.border = element_rect(colour = "grey40", fill = NA, size = rel(1)),
