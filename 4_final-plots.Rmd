...
if (save == T) { 
  ggsave("./plots/final/Fig1_workflow.png", width = 11.7, height = 2.5, dpi = dpi)
  ggsave("./plots/final/Fig1_workflow.pdf", width = 11.7, height = 2.5, device = cairo_pdf) 
}
```
...
if (save == T) { 
  ggsave("./plots/final/Fig2_pers_groups.png", width = 13.5, height = 7.5, dpi = dpi) 
  ggsave("./plots/final/Fig2_pers_groups.pdf", width = 13.5, height = 7.5, device = cairo_pdf)
}
```
...
if (save == T) {  
  ggsave("./plots/final/Fig3_dynamics_b+w.png", width = 8.9, height = 6.9, dpi = dpi)
  ggsave("./plots/final/Fig3_dynamics_b+w.pdf", width = 8.9, height = 6.9, device = cairo_pdf)
}
```
...
```{r fig-4-MultiBox, fig.width = 9, fig.height = 11.5}
## a) density of hosts
...
## final panel
if (save == T) { 
  ggsave("./plots/final/Fig4_multi_box.png", width = 9, height = 11.5, dpi = 750) 
  ggsave("./plots/final/Fig4b_multi_box.pdf", width = 9, height = 11.5, device = cairo_pdf) 
}
```
...
if (save == T) { 
  ggsave("./plots/final/Fig4b_multi_med.png", width = 9, height = 11.5, dpi = dpi) 
  ggsave("./plots/final/Fig4b_multi_med.pdf", width = 9, height = 11.5, device = cairo_pdf) 
}
```
...
if (save == T) { 
  ggsave("./plots/final/Fig5_pers_cfr.png", width = 8, height = 6.3, dpi = dpi) 
  ggsave("./plots/final/Fig5_pers_cfr.pdf", width = 8, height = 6.3, device = cairo_pdf)
}
```
...
if (save == T) { 
  ggsave("./plots/final/FigS7_cfr_persall.png", width = 7, height = 8, dpi = dpi) 
  ggsave("./plots/final/FigS7_cfr_persall.pdf", width = 7, height = 8, device = cairo_pdf) 
}
```
